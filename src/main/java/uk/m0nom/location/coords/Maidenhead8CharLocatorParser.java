...
public class Maidenhead8CharLocatorParser implements LocationParser, LocationFormatter {
    private final static Pattern PATTERN = Pattern.compile("^([A-Ra-r]{2}[0-9]{2}[A-Xa-x]{2}[0-9]{2})$");
    @Override
    ...
    public String format(GlobalCoordinates coords) {
        return MaidenheadLocatorConversion.coordsToLocator(coords, 8);
    }

    @Override
    public String getName() {
        return "Maidenhead Locator 8 Char";
    }
