...
import uk.m0nom.location.osgb36.OsGb36Converter;
import uk.m0nom.location.osgb36.OsGb36ConverterResult;
...
public class OsGb36Parser5Digit implements LocationParser, LocationFormatter{
    ...
    public GlobalCoords3D parse(LocationSource source, String locationString) {
        ...
        if (matcher.find()) {
            ...
            return new GlobalCoords3D(result.getCoords(), 0.0, new LocationInfo(LocationAccuracy.OSGB36_5DIGIT, LocationSource.OSGB36_CONVERTER));
        }
        return null;
    }
